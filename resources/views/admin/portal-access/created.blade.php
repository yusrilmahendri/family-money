...
@section('content')
    ...
    <p>Nama akses: <strong>{{ $accessToken->name }}</strong></p>
    ...
    <p class="text-muted" style="font-size:13px;">
        Portal access adalah secret credential. Jangan bagikan secara publik.
    </p>

    <a href="{{ route('admin.portal-access.index') }}" class="btn btn-primary">Selesai</a>
@endsection
