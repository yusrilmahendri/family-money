...
@section('content')
    ...
    <form method="POST" action="{{ route('entity.transactions.update', [$entity, $transaction]) }}">
        ...
        <div class="form-group">
            ...
            <input id="transaction_date" type="date" class="form-control" name="transaction_date" value="{{ old('transaction_date', $transaction->transaction_date?->toDateString()) }}" required>
        </div>
        <div class="form-group">
            <label for="description">Deskripsi</label>
            <input id="description" class="form-control" name="description" value="{{ old('description', $transaction->description) }}" maxlength="255">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="detail_description" class="form-control" name="detail_description" rows="3" maxlength="2000" placeholder="Contoh: pembayaran ipong ke-3, belanja kebutuhan rumah, biaya perjalanan Jogja">{{ old('detail_description', $transaction->resolvedDetailDescription()) }}</textarea>
        </div>
